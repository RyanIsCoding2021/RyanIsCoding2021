...
screen = pygame.display.set_mode(WINDOW_SIZE,0,32) # nitiate the window
...
grass_sounds[0].set_volume(0.01)
grass_sounds[1].set_volume(0.01)
...
coin_rect = pygame.Rect(100,100,5,5)
...
def collision_with_coines():
        if player_rect.colliderect(coin_rect):
            coin_img.goto(1000, 1000)
